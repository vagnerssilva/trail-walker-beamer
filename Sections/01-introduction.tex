...
\begin{frame}[t]{O projeto}
    ...
    espaço no laboratório. O sistema robótico deve ser capaz de reconhecer marcos fiduciais e desviar de obstáculos. 
        \begin{center}
            \includegraphics[width=0.45\textwidth]{walker}
        \end{center}
\end{frame}
%-
...
\begin{frame}[t]{Metodologia} 
    \centering
    \includegraphics[width=.80\textwidth]{metodologia.drawio.png}
...
\begin{frame}[t]{O que foi desenvolvido} 
        \begin{columns}[c]
            ...
            \column{.6\textwidth}
            \begin{columns}[c]
                \includegraphics[width=0.8\textwidth]{grafico-acompanhamento.png}
            \end{columns}
        \end{columns}
